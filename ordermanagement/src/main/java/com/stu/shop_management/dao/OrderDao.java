...
public class OrderDao {
    ...
    public static boolean updateCustomer(
        ...
        try {
            ...
            ps = con.prepareStatement(
                    "update customers set customer_name=?, email=? where customer_id=?"
            );
    ...
    public static boolean createOrder(
        ...
        try {
            ...
            if (rs.next()) {
                ...
                ps = con.prepareStatement(
                        "insert into orders(customer_id,order_date,total_amount) values(?,CURRENT_DATE,?)"
                );
     ...
     */
    public static void getOrdersByCustomer(
            long customerId) {
